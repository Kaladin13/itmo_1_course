...
public class ServerExecutor implements CommandExecutor{
    ...
    public void showCommand() {
        ArrayDeque<String> arrayDeque = vehicleService.getCollectionToString();
        String answer = "Elements of the collection";
        ServerAnswerDTO answerDTO = new ServerAnswerDTO(answer, arrayDeque);
        socketHandling.sendAnswer(answerDTO);
    }
    ...
    public void greaterCapacityCommand(Object obj) {
        ...
        ArrayDeque<String> vehicles = vehicleService.countCapacity(capacity);
        String answer = "Vehicles with greater capacity";
        socketHandling.sendAnswer(new ServerAnswerDTO(answer, vehicles));
    }
